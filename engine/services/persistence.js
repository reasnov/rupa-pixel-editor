...
export class PersistenceService {
    ...
    async save() {
        ...
        const res = await window.electronAPI.saveFile(data, editor.project.currentFilePath || undefined);
        if (res) {
