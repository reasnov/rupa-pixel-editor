...
export class ColorLogic {
    ...
    static toHex(hsla) {
        ...
        const hexComponent = (x) => Math.round(x * 255)
            .toString(16)
            .padStart(2, '0');
     ...
     */
    static mix(colorA, colorB, ratio = 0.5) {
    ...
    static toRGBA(hexStr) {
        if (this.rgbaCache.has(hexStr))
            return this.rgbaCache.get(hexStr);
