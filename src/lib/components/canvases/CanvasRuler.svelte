...
<div
	class="pointer-events-none relative h-full w-full overflow-hidden bg-canvas-bg/80 backdrop-blur-sm"
	role="presentation"
>
	<!-- 
		The Ruler Strip:
	...
	>
		...
		{#each markers as marker (marker.pos)}
			...
			>
				<span
					class="font-mono text-[8px] font-bold text-text-main/40"
		...
		-->
		<div
			class="absolute z-20 bg-ui-accent transition-all duration-75 ease-out"
			style="
		...
		>
			<div
				class="absolute top-1/2 left-1/2 rounded-sm bg-ui-accent px-1 py-0.5 shadow-sm"
