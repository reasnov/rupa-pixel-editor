...
<div class="pointer-events-none fixed bottom-0 left-0 z-[1000] w-full">
	<div
		class="flex h-7 w-full items-center justify-between border-t border-brand/20 bg-white/90 px-6 shadow-2xl backdrop-blur-md"
	>
		<div class="flex items-center gap-6">
			<!-- Section: Chord Ledger -->
			<div class="flex items-center gap-2">
				<span
					class="font-serif text-[8px] font-black tracking-widest text-brand/40 uppercase italic"
					>Chord:</span
				>
