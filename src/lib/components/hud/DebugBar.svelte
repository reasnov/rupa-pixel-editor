...
<div class="pointer-events-none fixed bottom-0 left-0 z-[1000] w-full">
	<div class="flex w-full items-center justify-between border-t border-brand/20 bg-white/90 px-6 py-1 shadow-2xl backdrop-blur-md">
		...
		<div class="flex items-center gap-4 opacity-40">
			<div class="flex gap-3 font-mono text-[8px] font-bold uppercase tracking-tighter">
				...
				<span>Ver: {atelier.version}</span>
			</div>
			<div class="h-3 w-px bg-brand/20"></div>
			<span class="font-mono text-[9px] font-black tracking-widest uppercase">
				Atelier Technical Ledger
			</span>
		</div>
	</div>
</div>
