...
<div class="toolbar custom-scrollbar flex h-full flex-col items-center gap-4 overflow-y-auto py-4">
	{#if side === 'left'}
		<!-- Main Drawing Tools -->
				...
				<div class="relative">
					...
					{#if tool.id === 'POLYGON' && studio.activeTool === 'POLYGON'}
						...
						>
							...
							<div class="my-1 h-px w-2 bg-text-main/10"></div>
	...
	{:else}
		...
		<div class="h-px w-4 bg-text-main/10"></div>
