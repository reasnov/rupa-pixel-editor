<script lang="ts">
	...
	let { onClose = () => (atelier.studio.showArtisanGuide = false) } = $props<{ onClose: () => void }>();
...
<Modal title="Artisan's Guide" subtitle="Mastering the Digital Loom" icon="📜" {onClose} width="600px">
