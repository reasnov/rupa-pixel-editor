export class ExportEngine {
		 ...
		 */
		static toSVG(width: number, height: number, data: string[], bgColor: string | 'transparent' = 'transparent'): string {
		 ...
		 */
		static async toPNG(width: number, height: number, data: string[], scale: number, bgColor: string | 'transparent' = 'transparent'): Promise<string> {
