...
export class EditorState {
    ...
    cameraTransform = $derived.by(() => {
        return Geometry.calculateCameraTransform(this.studio.zoomLevel, this.studio.panOffset, this.cursor.pos, this.canvas.width, this.canvas.height);
    });
    ...
    handleEscape() {
        ...
        // Shading Reset
        if (this.studio.isShadingLighten ||
